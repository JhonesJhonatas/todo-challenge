  ...
  return (
    <div className='bg-gray-700 rounded border border-gray-500 p-5 flex justify-between items-center'>
      ...
      <div className='flex gap-3 items-center'>
        ...
        <input name="checkBoxInput" className='border-2 bg-transparent rounded-full cursor-pointer border-gray-400 hover:bg-blue-950' type="checkbox" />

        <p className='text-gray-100'>Task de Exemplo</p>
