...
export function Form(){
  return(
    <form className='flex justify-center -mt-6 gap-4 w-5/12 mx-auto'>
        <input className="p-3 rounded text-gray-100 bg-gray-700 w-full focus:outline-none focus:outline focus:outline-blue-500" type="text" placeholder='Adicione uma nova tarefa' />
